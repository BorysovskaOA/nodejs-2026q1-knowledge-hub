...
import { UpdatePasswordDto } from 'src/user/models/update-password.dto';
...
const wrongFormatTests = [
  { property: 'oldPassword', value: 2, constraint: 'isString' },
  { property: 'newPassword', value: 2, constraint: 'isString' },
];

describe('Update Password DTO', () => {
