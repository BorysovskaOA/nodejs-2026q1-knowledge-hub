...
describe('Comment Controller', () => {
  ...
  it('should have the correct base path', () => {
    const path = Reflect.getMetadata(PATH_METADATA, CommentController);

    expect(path).toBe('comment');
  });
  ...
  describe('getAll', () => {
    ...
    it('should take correct arguments', async () => {
      ...
      expect(paramsTypes[0]).toBe(CommentListFiltersDto);
    });

    it('should return correct format', async () => {
      mockService.getAll.mockResolvedValue([comment]);
  ...
  describe('getAllPaginated', () => {
    ...
    it('should take correct arguments', async () => {
      ...
      expect(paramsTypes[0]).toBe(CommentListFiltersPaginatedDto);
    });
  ...
  describe('create', () => {
    ...
    it('should take correct arguments', async () => {
      ...
      expect(paramsTypes[0]).toBe(CreateCommentDto);
    });

    it('should return correct format', async () => {
      mockService.create.mockResolvedValue(comment);
  ...
  describe('getById', () => {
    ...
    it('should return correct format', async () => {
      mockService.getById.mockResolvedValue(comment);
  ...
  describe('update', () => {
    ...
    it('should take correct arguments', async () => {
      ...
      expect(paramsTypes[0]).toBe(IdParamDto);
      expect(paramsTypes[1]).toBe(UpdateCommentDto);
    });

    it('should return correct format', async () => {
      mockService.update.mockResolvedValue(comment);
  ...
  describe('delete', () => {
    ...
    it('should return correct format', async () => {
      mockService.delete.mockResolvedValue(comment);
